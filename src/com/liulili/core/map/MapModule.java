...
public class MapModule {
	 ...
	 */
	@At("/map/search")
	public String search(@Param("shopaddr")String shopaddr,@Param("customeraddr")String customeraddr,HttpServletRequest request){
		...
		log.debug("门店地址："+shopaddr);
		log.debug("客户地址："+customeraddr);
